...
- Show the full issue in a markdown code block: Title and Body
...
- **AC describes outcomes, not implementation** — observable results only; no class names, library names, file paths, or tool choices in AC. Those belong in Technical Notes.
- **No implementation in summary** — describe *what* and *why*, not *how*
- **Technical Notes are optional** — omit them unless context is genuinely non-obvious. When in doubt, leave the section out.
